...
2.  **Install Dependencies (One Time):**
    ...
    This command will install all the required dependencies listed in the `yarn.lock` file. You only need to run this command _once_ when you first set up the project. If you later add new dependencies, you'll need to run it again.
...
**_Note:_** The first section here is primarily for testing that your setup is correct. The remaining sections are for you to explore and play around with if you'd like. We will be covering all of these items in the later weeks of the curriculum.
